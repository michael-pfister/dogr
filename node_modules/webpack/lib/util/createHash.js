...
// Note: Added the `loadCrypto()` function to override the `crypto` module's `createHash()` method. If the "md4" algorithm gets passed to the `createHash()` method, then call the `createHash()` method with the "md5" algorithm instead.
function loadCrypto() {
